    ...
    if (load.good())
    {
        ...
        while (LastGameContinue)
        {
            ...
            if (ch == 'y')
            {
                ...
                Prevscore = LoadLastRawScore(filename);
                FirstGenerate = false;
                CanGenerate = false;
                ...
                if (true)
                {
                    ...
                    if (QuitSure == 'y')
                    {
                        ...
                        if (SaveSure == 'y')
                        {
                            ...
                            else if (HighestScore > score)    // last challenge(changed to have condition)
                                SaveHighScore2(HighestScore); // last challenge(changed to 2)
